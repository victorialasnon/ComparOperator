        ...
        <div class = "container" >
            ...
            <div class = "collapse navbar-collapse"
                ...
                <ul class = "navbar-nav ml-auto" >
                    ...
                    <li class = "nav-item" >
                        <a class = "nav-link js-scroll-trigger"
                           href = "./add_tour-operator.php" >Tours</a >
                    </li >
                    <li class = "nav-item" >
                        <a class = "nav-link js-scroll-trigger"
                           href = "add_destination.php" >Destinations</a >
                    </li >
                    <li class = "nav-item active" >
                        <a class = "nav-link js-scroll-trigger"
                           href = "./see_reviews.php" >See Reviews</a >
                    </li >
...
<main class="destination-main">
    <h1 class="text-center mt-4">REVIEWS BASE DE DONNEES</h1 >
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-3">
                                <a href="#" class="float-right btn text-white
                                btn-danger">
